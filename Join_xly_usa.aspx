    ...
    <div class="m-bottom">
        <ul id="footermenu">
            <li style="width:100%;">
                ...
                <a href="javascript:SubOrder();" style="display:block; margin-top:5px;" ><button type="button" style="width:90%; padding:6px 0;" class="btn btn-danger" onclick="SubOrder();">报 名</button></a>
...
<script runat="server">
    ...
    private void submitOrder(string token)
    {
        ...
        else
        {
            ...
            if (Request["productid"].ToString().Equals("77"))
            {
                //int discount = 0;
                //if (this.Session["RepeatCustomer"].ToString().Equals("1"))
                //{
                ...
                Response.Redirect("JoinSuccess.aspx?name=大开眼界：预见未来的自己——美国创新科技体验营");
                return;
            }
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        lineLink = 'http://mall.luqinwenda.com/Join_xly_usa.aspx?productid=' + prodid;
        so_fillProd_xly();
