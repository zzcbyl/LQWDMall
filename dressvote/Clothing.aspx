        ...
        $(document).ready(function () {
            ...
            if (QueryString('clothingid') != null && QueryString('clothingid') != "") {
                ...
                $(".main_image li").each(function () {
                    $(this).find('img').attr("src", "images/clothing" + QueryString('clothingid') + "/0" + i + ".jpg");
                    i++;
                });
            }
    ...
    <div class="main_visual">
	    <div class="main_image">
		    <ul>
			    ...
			    <li><span class=""><img src="images/clothing1/02.jpg" height="100%" /></span></li>
                <li><span class=""><img src="images/clothing1/03.jpg" height="100%" /></span></li>
                <li><span class=""><img src="images/clothing1/04.jpg" height="100%" /></span></li>
                <li><span class=""><img src="images/clothing1/05.jpg" height="100%" /></span></li>
		    </ul>
